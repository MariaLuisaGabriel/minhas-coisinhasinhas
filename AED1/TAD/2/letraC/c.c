...
int main()
{
    ...
    while(1)
    {
        ...
        if(p==0 && j==1)
        {
            printf("\ndefina um tamanho maximo para sua lista: ");
            scanf("%d",&pos);
            a = criar(pos);
            p=1;
        }
        ...
        switch(j)
        {
                    ...
                    case 3:
                    {
                        ...
                        switch(r)
                        {
                            ...
                            case 2:
                                printf("\nlista inexistente!\n");p=0;break;
                            case 8:
                                printf("\nposicao alem dos limites da lista!\n");break;
                        }
                        break;
                    }
                }
            ...
            case 6:
            {
                printf("\ninsira a matricula do aluno que quer verificar se esta na lista: ");
                scanf("%d",&pos);
                r = contemItem(a,pos);
                switch(r)
                {
                    case 0:
                        printf("\naluno nao esta contido na lista!\n");break;
                    case 1:
                        printf("\naluno esta contido na lista!\n");break;
                }
                break;
            }
            case 7:
